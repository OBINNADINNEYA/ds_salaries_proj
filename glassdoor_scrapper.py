...
def get_jobs(keyword, num_jobs, verbose,slp_time,path):
    ...
    #url = "https://www.glassdoor.com/Job/" + keyword + "-jobs-SRCH_KO0,14.htm?includeNoSalaryJobs=true&jl=1008659978629"
    ...
    while len(jobs) < num_jobs:  #If true, should be still looking for new jobs.
       ...
       # try:
        ...
        job_buttons = driver.find_element(By.C, "jl")  #jl for Job Listing. These are the buttons we're going to click.
